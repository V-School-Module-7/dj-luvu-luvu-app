    ...
    return(
        <div className='soundcloud'>
                ...
                <div className='allSongsDiv'>
                    ...
                    <div className='songDiv' onClick={() => handleChange("https://www.mixcloud.com/widget/iframe/?feed=%2Fdjluvaluva%2F2000s-rb-mix%2F")}>
                        <img src="https://i1.sndcdn.com/artworks-000560087532-6vh1ah-t500x500.jpg" alt="Song 9"/>
                        <div className='songTitle'>2000s R&B Mix</div>
                    </div>
                    {/* three */}
                    <hr className='songSpacer' />
